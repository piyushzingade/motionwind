    ...
    <div className="flex h-full flex-col min-w-[260px]">
      ...
      <div className="border-t border-dashed border-[var(--color-border)] p-3">
        <Link
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-[var(--color-border)] px-3 py-2 text-xs text-[var(--color-fg-muted)] transition-colors hover:border-[var(--color-accent)]/30 hover:text-[var(--color-fg)] no-underline"
        >
          <svg
            width="14"
            height="14"

      ...
      <div className="mx-auto max-w-7xl flex items-center justify-between h-14 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex h-7 items-center gap-1.5 rounded-md border border-border bg-surface-elevated px-2.5 text-xs text-fg-muted transition-colors hover:border-accent/20 hover:text-fg"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"

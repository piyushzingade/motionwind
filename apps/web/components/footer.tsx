...
export function Footer() {
  return (
    <footer className="relative px-4 pb-10 pt-28 sm:px-6 sm:pb-12 md:pt-32">
      <div className="mx-auto flex min-h-[420px] max-w-[960px] flex-col items-center justify-start pt-8 text-center sm:pt-12 md:min-h-[460px] md:pt-16">
        ...
        <nav
          ...
          className="mt-auto flex w-full flex-wrap justify-center gap-x-8 gap-y-4 border-t border-border-subtle pt-6 text-sm text-code-muted sm:gap-x-10"
        >
          <Link

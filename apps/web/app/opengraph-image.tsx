  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
        <div style={{ color: "#c9ff33", fontSize: 22, letterSpacing: "0.16em", textTransform: "uppercase" }}>
          Motion for utility classes
        </div>
        <div style={{ fontSize: 68, fontWeight: 700, letterSpacing: "-0.06em", lineHeight: 1.02 }}>
          Ship motion that matters.
        </div>
        <div style={{ color: "#a2a2b0", fontSize: 25 }}>
          Write animation intent. Compile it into production-ready Motion props.
        </div>
      </div>

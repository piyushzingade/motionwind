    ...
    <header className="flex h-14 shrink-0 items-center justify-between gap-2 border-b border-dashed border-[var(--color-border)] px-4 sticky top-0 bg-[var(--color-bg)]/80 backdrop-blur-md z-40">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link
          ...
          className="inline-flex h-7 items-center gap-1.5 rounded-md bg-[var(--color-surface-elevated)] border border-[var(--color-border)] px-2.5 text-xs text-[var(--color-fg-muted)] no-underline transition-colors hover:text-[var(--color-fg)] hover:border-[var(--color-accent)]/20"
        >

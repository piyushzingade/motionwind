...
<Demo title="Hover to Stretch Horizontally">
  <div className="w-24 h-16 bg-fd-primary rounded-xl flex items-center justify-center text-fd-primary-foreground font-bold cursor-pointer animate-hover:scale-x-120 animate-spring">
    X
  </div>
</Demo>
...
<Demo title="Hover to Stretch Vertically">
  <div className="w-16 h-24 bg-fd-primary rounded-xl flex items-center justify-center text-fd-primary-foreground font-bold cursor-pointer animate-hover:scale-y-120 animate-spring">
    Y
  </div>
</Demo>
...
<Demo title="Tap to Squash">
  <div className="w-20 h-20 bg-fd-primary rounded-2xl flex items-center justify-center text-fd-primary-foreground font-bold cursor-pointer animate-hover:scale-y-80 animate-hover:scale-x-120 animate-tap:scale-y-70 animate-tap:scale-x-130 animate-spring animate-stiffness-400 animate-damping-10">
    Boing
  </div>
</Demo>
...
<Demo title="Hover to Tilt Forward">
  <div className="[perspective:800px]">
    <div className="w-32 h-20 bg-fd-primary rounded-xl flex items-center justify-center text-fd-primary-foreground font-bold cursor-pointer animate-hover:rotate-x-45 animate-spring">
      Tilt X
    </div>
  </div>
</Demo>
...
<Demo title="Hover to Swing Open">
  <div className="[perspective:800px]">
    <div className="w-32 h-20 bg-fd-primary rounded-xl flex items-center justify-center text-fd-primary-foreground font-bold cursor-pointer animate-hover:rotate-y-45 animate-spring">
      Tilt Y
    </div>
  </div>
</Demo>
...
<Demo title="Hover to Skew Horizontally">
  <div className="px-8 py-4 bg-fd-primary rounded-xl text-fd-primary-foreground font-bold cursor-pointer animate-hover:skew-x-12 animate-spring">
    Skew X
  </div>
</Demo>
...
<Demo title="Hover to Skew Vertically">
  <div className="px-8 py-4 bg-fd-primary rounded-xl text-fd-primary-foreground font-bold cursor-pointer animate-hover:skew-y-12 animate-spring">
    Skew Y
  </div>
</Demo>
...
<Demo title="Negative Transforms">
  <div className="flex gap-6 items-center">
    <div className="w-16 h-16 bg-fd-primary rounded-lg flex items-center justify-center text-fd-primary-foreground font-bold cursor-pointer animate-hover:-rotate-45 animate-spring">
      -45
    </div>
    <div className="w-16 h-16 bg-fd-primary/70 rounded-lg flex items-center justify-center text-fd-primary-foreground font-bold cursor-pointer animate-hover:-skew-x-12 animate-spring">
      -Sk
    </div>
    <div className="w-16 h-16 bg-fd-primary/40 rounded-lg flex items-center justify-center text-fd-primary-foreground font-bold cursor-pointer animate-hover:-x-20 animate-spring">
      -X
    </div>
  </div>
</Demo>
...
<Demo title="3D Hover Card">
  <div className="[perspective:800px]">
    <div className="w-48 h-32 bg-gradient-to-br from-[#c8ff2e]/20 to-[#c8ff2e]/5 border border-[#c8ff2e]/30 rounded-2xl flex items-center justify-center text-[var(--color-fg)] font-medium cursor-pointer animate-hover:rotate-x-10 animate-hover:-rotate-y-10 animate-hover:scale-105 animate-spring">
      3D hover card
    </div>
  </div>
</Demo>
  ...
  <div className="flex gap-8 items-center">
    <div className="text-center">
      <div className="[perspective:300px] mb-2">
        <div className="w-20 h-14 bg-fd-primary rounded-lg flex items-center justify-center text-fd-primary-foreground font-bold cursor-pointer animate-hover:rotate-y-30 animate-spring">
          300
        </div>
      </div>
      <span className="text-xs text-[var(--color-fg-muted)]">300px</span>
    </div>
    <div className="text-center">
      ...
      <span className="text-xs text-[var(--color-fg-muted)]">600px</span>
    </div>
    <div className="text-center">
      ...
      <span className="text-xs text-[var(--color-fg-muted)]">1200px</span>
    </div>
  </div>
</Demo>

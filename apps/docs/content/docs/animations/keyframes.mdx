...
<Demo title="Breathing animation">
  <div className="animate-enter:scale-[100,110,100] animate-repeat-infinite animate-duration-2000 w-20 h-20 rounded-full bg-[#c8ff2e]/60 flex items-center justify-center">
    <div className="w-10 h-10 rounded-full bg-[#c8ff2e]" />
  </div>
</Demo>
...
<Demo title="Rectangular path">
  <div className="animate-enter:x-[0,100,100,0] animate-enter:y-[0,0,-50,0] animate-duration-3000 animate-repeat-infinite animate-ease-in-out w-12 h-12 rounded-lg bg-[#c8ff2e]" />
</Demo>
...
<Demo title="Reverse repeat">
  <div className="animate-enter:x-100 animate-repeat-infinite animate-repeat-reverse animate-duration-1000 w-12 h-12 rounded-lg bg-[#c8ff2e]" />
</Demo>
...
<Demo title="Pulse with repeat delay">
  <div className="animate-initial:scale-100 animate-enter:scale-110 animate-repeat-infinite animate-repeat-reverse animate-repeat-delay-500 animate-duration-600 animate-ease-in-out w-20 h-20 rounded-full bg-[#c8ff2e]/60 flex items-center justify-center">
    <div className="w-10 h-10 rounded-full bg-[#c8ff2e]" />
  </div>
</Demo>
...
<Demo title="Square path with times">
  <div className="animate-enter:x-[0,100,100,0,0] animate-enter:y-[0,0,-100,-100,0] animate-times-[0,0.25,0.5,0.75,1] animate-duration-4000 animate-repeat-infinite animate-ease-linear w-12 h-12 rounded-lg bg-[#c8ff2e]" />
</Demo>

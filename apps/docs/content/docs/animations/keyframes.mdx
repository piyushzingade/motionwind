...
<Demo title="Pulse">
  <div className="animate-initial:scale-100 animate-enter:scale-120 animate-repeat-infinite animate-repeat-reverse animate-duration-1000 animate-ease-in-out w-20 h-20 rounded-full bg-fd-primary/60 flex items-center justify-center">
...
<Demo title="Breathing animation">
  <div className="animate-enter:scale-[100,120,100] animate-repeat-infinite animate-duration-2000 animate-ease-in-out w-20 h-20 rounded-full bg-fd-primary/60 flex items-center justify-center">
    <div className="w-10 h-10 rounded-full bg-fd-primary" />
  </div>
</Demo>
...
<Demo title="Pulse with repeat delay">
  <div className="animate-initial:scale-100 animate-enter:scale-120 animate-repeat-infinite animate-repeat-reverse animate-repeat-delay-500 animate-duration-600 animate-ease-in-out w-20 h-20 rounded-full bg-fd-primary/60 flex items-center justify-center">
    <div className="w-10 h-10 rounded-full bg-fd-primary" />
  </div>
</Demo>

...
<Demo title="Floating Element">
  <div className="animate-initial:y-0 animate-enter:y--10 animate-repeat-infinite animate-duration-2000 animate-ease-in-out w-16 h-16 rounded-2xl bg-[#c8ff2e] flex items-center justify-center shadow-lg shadow-[#c8ff2e]/20">
...
<Demo title="Breathing Pulse">
  <div className="flex items-center gap-3">
    <div className="animate-initial:scale-100 animate-enter:scale-105 animate-repeat-infinite animate-duration-2000 animate-ease-in-out w-4 h-4 rounded-full bg-[#c8ff2e] shadow-md shadow-[#c8ff2e]/30" />
...
<Demo title="Hover Shift (motionwind Approximation)">
  <button className="animate-hover:x-3 animate-hover:y--3 animate-spring animate-stiffness-400 animate-damping-15 px-6 py-3 rounded-lg bg-[#c8ff2e] text-black font-semibold cursor-pointer select-none">
    Hover me
  </button>
</Demo>
...
<Demo title="Square to Circle Morph">
  <div className="animate-hover:rounded-50 animate-duration-500 animate-ease-in-out w-24 h-24 bg-[#c8ff2e] cursor-pointer" />
</Demo>
...
<Demo title="Infinite Loop">
  <div className="w-full max-w-[300px] overflow-hidden">
    <div className="animate-initial:x-0 animate-enter:x-200 animate-repeat-infinite animate-duration-3000 animate-ease-linear w-8 h-8 rounded-full bg-[#c8ff2e] shadow-md shadow-[#c8ff2e]/20" />
  </div>
</Demo>
...
<Demo title="Combined Hover + Tap">
  <button className="animate-hover:y--4 animate-hover:scale-105 animate-tap:scale-95 animate-tap:y-0 animate-spring animate-stiffness-300 animate-damping-20 px-8 py-4 rounded-xl bg-[#c8ff2e] text-black font-bold cursor-pointer select-none">
    Interactive Button
  </button>
</Demo>

...
<Playground initial="animate-variant-hidden:opacity-0 animate-variant-hidden:y-20 animate-variant-visible:opacity-100 animate-variant-visible:y-0 animate-from-hidden animate-to-visible animate-duration-500 rounded-xl bg-fd-primary px-6 py-4 text-fd-primary-foreground font-medium" text="Named states" />

```html
<div className="animate-variant-hidden:opacity-0 animate-variant-hidden:y-20 animate-variant-visible:opacity-100 animate-variant-visible:y-0 animate-from-hidden animate-to-visible animate-duration-500">
...
<ul className="animate-to-visible animate-stagger-100">
  <li className="animate-variant-hidden:opacity-0 animate-variant-visible:opacity-100">One</li>
  <li className="animate-variant-hidden:opacity-0 animate-variant-visible:opacity-100">Two</li>
</ul>
```
...
<Demo title="Stagger with delay classes">
  <div className="flex gap-3">
    <div className="animate-initial:opacity-0 animate-initial:y-20 animate-enter:opacity-100 animate-enter:y-0 animate-duration-500 w-12 h-12 rounded-lg bg-fd-primary flex items-center justify-center text-fd-primary-foreground font-bold">1</div>
    <div className="animate-initial:opacity-0 animate-initial:y-20 animate-enter:opacity-100 animate-enter:y-0 animate-duration-500 animate-delay-100 w-12 h-12 rounded-lg bg-fd-primary/80 flex items-center justify-center text-fd-primary-foreground font-bold">2</div>
    <div className="animate-initial:opacity-0 animate-initial:y-20 animate-enter:opacity-100 animate-enter:y-0 animate-duration-500 animate-delay-200 w-12 h-12 rounded-lg bg-fd-primary/60 flex items-center justify-center text-fd-primary-foreground font-bold">3</div>
    <div className="animate-initial:opacity-0 animate-initial:y-20 animate-enter:opacity-100 animate-enter:y-0 animate-duration-500 animate-delay-300 w-12 h-12 rounded-lg bg-fd-primary/40 flex items-center justify-center text-fd-primary-foreground font-bold">4</div>
  </div>
</Demo>

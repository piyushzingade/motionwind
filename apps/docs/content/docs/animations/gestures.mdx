...
<Demo title="Card Lift on Hover">
  <div className="w-56 px-6 py-5 bg-white/5 border border-white/10 rounded-2xl cursor-pointer animate-hover:scale-105 animate-hover:-y-4 animate-hover:[backgroundColor=#c8ff2e] animate-hover:[color=#000000] animate-spring">
...
<Demo title="Button Press Effect">
  <button className="px-8 py-3 bg-[#c8ff2e] text-black rounded-xl font-medium cursor-pointer animate-tap:scale-95 animate-spring">
    Press me
  </button>
</Demo>
...
<Demo title="Tap to Tilt">
  <div className="w-16 h-16 bg-[#c8ff2e] rounded-2xl flex items-center justify-center text-2xl cursor-pointer animate-tap:scale-90 animate-tap:rotate-12 animate-spring animate-stiffness-400">
    *
  </div>
</Demo>
...
<Demo title="Input Focus Animation">
  <input className="px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/40 outline-none w-64 animate-focus:scale-105 animate-focus:[borderColor=#c8ff2e] animate-spring" placeholder="Click or Tab to focus" />
</Demo>
...
<Demo title="Search Bar Focus">
  <input className="px-5 py-3 bg-white/5 border border-white/10 rounded-full text-white placeholder-white/30 outline-none w-72 animate-focus:scale-105 animate-focus:[backgroundColor=#ffffff15] animate-spring" placeholder="Search..." />
</Demo>
...
<Demo title="Draggable Element">
  <div className="w-20 h-20 bg-[#c8ff2e] rounded-2xl flex items-center justify-center text-black font-bold cursor-grab active:cursor-grabbing select-none animate-drag-both animate-drag:scale-110 animate-drag:rotate-12 animate-spring animate-drag-elastic-50">
    Drag
  </div>
</Demo>
...
<Demo title="Horizontal Drag Only">
  <div className="w-16 h-16 bg-[#c8ff2e]/70 rounded-xl flex items-center justify-center text-black font-bold cursor-grab active:cursor-grabbing select-none animate-drag-x animate-drag:scale-105 animate-spring animate-drag-elastic-20">
    X
  </div>
</Demo>
...
<Demo title="Scroll Reveal (visible on load)">
  <div className="px-8 py-6 bg-white/5 border border-white/10 rounded-2xl text-white font-medium animate-initial:opacity-0 animate-initial:y-20 animate-inview:opacity-100 animate-inview:y-0 animate-once animate-duration-600 animate-ease-out">
...
<Demo title="Scale In on View">
  <div className="w-32 h-20 bg-[#c8ff2e] rounded-2xl flex items-center justify-center text-black font-bold animate-initial:opacity-0 animate-initial:scale-50 animate-inview:opacity-100 animate-inview:scale-100 animate-once animate-spring">
    Pop in
  </div>
</Demo>
...
<Demo title="Hover + Tap Button">
  <button className="px-8 py-3 bg-[#c8ff2e] text-black rounded-xl font-semibold cursor-pointer animate-hover:scale-110 animate-tap:scale-95 animate-spring">
    Interactive button
  </button>
</Demo>
...
<Demo title="Slide Up + Fade In">
  <div className="flex gap-4">
    <div className="w-20 h-20 bg-[#c8ff2e]/20 border border-[#c8ff2e]/40 rounded-xl flex items-center justify-center text-white font-bold animate-initial:opacity-0 animate-initial:y-30 animate-inview:opacity-100 animate-inview:y-0 animate-once animate-duration-500 animate-ease-out">
      1
    </div>
    <div className="w-20 h-20 bg-[#c8ff2e]/20 border border-[#c8ff2e]/40 rounded-xl flex items-center justify-center text-white font-bold animate-initial:opacity-0 animate-initial:y-30 animate-inview:opacity-100 animate-inview:y-0 animate-once animate-duration-500 animate-delay-100 animate-ease-out">
      2
    </div>
    <div className="w-20 h-20 bg-[#c8ff2e]/20 border border-[#c8ff2e]/40 rounded-xl flex items-center justify-center text-white font-bold animate-initial:opacity-0 animate-initial:y-30 animate-inview:opacity-100 animate-inview:y-0 animate-once animate-duration-500 animate-delay-200 animate-ease-out">
      3
    </div>
  </div>
</Demo>
...
<Demo title="All Gesture States">
  <input className="px-5 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-white/30 outline-none w-72 animate-hover:scale-102 animate-focus:scale-105 animate-focus:[borderColor=#c8ff2e] animate-tap:scale-98 animate-spring" placeholder="Hover, focus, or tap me" />
</Demo>
...
<Demo title="Animate on Mount">
  <div className="px-8 py-4 bg-[#c8ff2e] text-black rounded-xl font-semibold animate-initial:opacity-0 animate-initial:scale-80 animate-initial:-y-10 animate-enter:opacity-100 animate-enter:scale-100 animate-enter:y-0 animate-spring">
    Animated on mount
  </div>
</Demo>

...
<Demo title="Drag X Only">
  <div className="animate-drag-x w-16 h-16 rounded-xl bg-fd-primary flex items-center justify-center text-xs font-semibold text-fd-primary-foreground cursor-grab active:cursor-grabbing select-none">
    X
  </div>
</Demo>
...
<Demo title="Drag Y Only">
  <div className="animate-drag-y w-16 h-16 rounded-xl bg-fd-primary flex items-center justify-center text-xs font-semibold text-fd-primary-foreground cursor-grab active:cursor-grabbing select-none">
    Y
  </div>
</Demo>
...
<Demo title="Drag Both Axes">
  <div className="animate-drag-both w-16 h-16 rounded-xl bg-fd-primary flex items-center justify-center text-xs font-semibold text-fd-primary-foreground cursor-grab active:cursor-grabbing select-none">
    XY
  </div>
</Demo>
...
<Demo title="Drag Elasticity Comparison" className="gap-8">
  <div className="flex flex-col items-center gap-2">
    <div className="animate-drag-both animate-drag-elastic-10 w-14 h-14 rounded-xl bg-fd-primary flex items-center justify-center text-xs font-semibold text-fd-primary-foreground cursor-grab active:cursor-grabbing select-none">
      10
    </div>
    <span className="text-xs text-fd-muted-foreground">Low</span>
  </div>
  <div className="flex flex-col items-center gap-2">
    <div className="animate-drag-both animate-drag-elastic-50 w-14 h-14 rounded-xl bg-fd-primary flex items-center justify-center text-xs font-semibold text-fd-primary-foreground cursor-grab active:cursor-grabbing select-none">
      50
    </div>
    <span className="text-xs text-fd-muted-foreground">Medium</span>
  </div>
  <div className="flex flex-col items-center gap-2">
    <div className="animate-drag-both animate-drag-elastic-100 w-14 h-14 rounded-xl bg-fd-primary flex items-center justify-center text-xs font-semibold text-fd-primary-foreground cursor-grab active:cursor-grabbing select-none">
      100
    </div>
...
<Demo title="Drag with Visual Feedback">
  <div className="animate-drag-both animate-drag:scale-110 animate-drag:rotate-5 animate-spring w-16 h-16 rounded-xl bg-fd-primary flex items-center justify-center text-xs font-semibold text-fd-primary-foreground cursor-grab active:cursor-grabbing select-none shadow-lg">
    Grab
  </div>
</Demo>
...
<Demo title="Drag + Hover Gestures Combined">
  <div className="animate-drag-both animate-drag:scale-110 animate-drag:rotate-3 animate-hover:scale-105 animate-hover:opacity-80 animate-spring w-16 h-16 rounded-xl bg-fd-primary flex items-center justify-center text-xs font-semibold text-fd-primary-foreground cursor-grab active:cursor-grabbing select-none shadow-lg">
    Both
  </div>
</Demo>

...
One `animate-*` syntax, every framework — each powered by the shared `motionwind-core` parser.

| Framework | Package | Guide |
|---|---|---|
| **React** (Next.js / Vite) | `motionwind-react` | [Framework Setup](/docs/framework-setup#nextjs) |
| **React Native** / Expo | `motionwind-react-native` | [React Native](/docs/react-native) |
| **Vue 3** | `motionwind-vue` | [Framework Setup](/docs/framework-setup#vue) |
| **Vanilla / CDN** | `motionwind-vanilla` | [Framework Setup](/docs/framework-setup#vanilla-js) |

```html
<!-- The same class, anywhere -->

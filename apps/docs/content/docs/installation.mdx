...
The CLI auto-detects your package manager (npm, yarn, pnpm, or bun) and installs `motionwind` for you. Then follow the manual setup steps below to configure your build tool.

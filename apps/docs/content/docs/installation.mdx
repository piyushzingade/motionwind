...
**Next.js 15+:** If you use Turbopack (the default), add the `--webpack` flag for now. The motionwind Babel transform runs via webpack and is not yet supported under Turbopack:
